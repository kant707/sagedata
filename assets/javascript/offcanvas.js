...
(function($) {
  ...
  $(document).ready(function() {
    ...
    $('body').prepend('<div id="offcanvas-overlay"></div>');
    $('#logo-col').prepend('<div id="offcanvas-navicon"><span></span></div>');
    ...
    $('#offcanvas-navicon, #offcanvas-overlay').on('click', offcanvas_navicon);
    $('#offcanvas-navicon, #offcanvas-overlay').on('touchstart', offcanvas_navicon);


    // Offcanvas overlay

    $('#offcanvas-overlay').on('click', offcanvas_close);
    $('#offcanvas-overlay').on('touchstart', offcanvas_close);
